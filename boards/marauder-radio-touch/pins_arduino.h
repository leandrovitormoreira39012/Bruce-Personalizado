/* Pinos para Marauder Radio Touch (Ambiente 06) */

#ifndef PINS_ARDUINO_MARAUDER_RADIO_TOUCH_H
#define PINS_ARDUINO_MARAUDER_RADIO_TOUCH_H
...
#endif /* PINS_ARDUINO_MARAUDER_RADIO_TOUCH_H */
